...
public class RoomController extends EntityController<String, RoomService, RoomModel, RoomCreateModel>
{
    ...
    public @NotNull ResponseEntity<RoomModel @NonNull []> create(@NotNull @RequestBody RoomCreateModel[] model) throws CreationException
    {
    ...
    public @NotNull ResponseEntity<RoomModel @NonNull []> fetchAll() {return super.fetchAll();}
}
