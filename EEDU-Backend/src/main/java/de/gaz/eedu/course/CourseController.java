...
public class CourseController extends EntityController<Long, CourseService, CourseModel, CourseCreateModel>
{
    ...
    public @NotNull ResponseEntity<@NonNull Void> setSubject(@PathVariable long course, @PathVariable String subject)
    {
    ...
    public @NotNull ResponseEntity<@NonNull Void> attachUser(@PathVariable long course, @NotNull @RequestBody Long... users)
    {
    ...
    public @NotNull ResponseEntity<@NonNull Void> detachUser(@PathVariable long course, @NotNull @RequestBody Long... users)
    {
    ...
    public @NotNull ResponseEntity<CourseModel @NonNull []> create(@NotNull @RequestBody CourseCreateModel[] model)
    {
    ...
    public @NotNull ResponseEntity<@NonNull Void> delete(@NotNull @PathVariable Long[] id)
    {
        return super.delete(id);
    }

    @GetMapping("/users/{course}")
    public @NotNull ResponseEntity<ReducedUserModel @NonNull []> getUsers(@PathVariable long course)
    {
    ...
    public @NotNull ResponseEntity<@NonNull CourseModel> getData(@NotNull @PathVariable Long id)
    {
    ...
    @GetMapping("/get/all")
    @PreAuthorize("hasAuthority(T(de.gaz.eedu.user.privileges.SystemPrivileges).COURSE_GET.toString())") @Override
    public @NotNull ResponseEntity<CourseModel @NonNull []> fetchAll()
    {
        return super.fetchAll();
    }

    @GetMapping("/get") @PreAuthorize("@verificationService.isFullyAuthenticated()")
    public @NotNull ResponseEntity<CourseModel @NonNull []> getOwnCourses(@AuthenticationPrincipal long user)
    {
    ...
    public @NotNull ResponseEntity<CourseModel @NonNull []> getCourses(@PathVariable long user)
    {
