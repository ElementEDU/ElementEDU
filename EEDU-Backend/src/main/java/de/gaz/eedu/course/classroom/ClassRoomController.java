...
public class ClassRoomController extends EntityController<String, ClassRoomService, ClassRoomModel, ClassRoomCreateModel>
{
    ...
    public @NotNull ResponseEntity<@NonNull Void> linkClass(@PathVariable long course, @PathVariable String classroom)
    {
    ...
    public @NotNull ResponseEntity<@NonNull Void> unlinkClass(@PathVariable long course)
    {
    ...
    public @NotNull ResponseEntity<CourseModel @NonNull []> getCourses(@AuthenticationPrincipal long user, @PathVariable long classroom)
    {
    ...
    @Override public @NotNull ResponseEntity<ClassRoomModel @NonNull []> create(@NotNull @RequestBody ClassRoomCreateModel[] model)
    {
    ...
    @Override public @NotNull ResponseEntity<@NonNull Void> delete(@NotNull @PathVariable String[] id)
    {
        return super.delete(id);
    }
    @GetMapping("/get/{id}")
    @PreAuthorize("hasAuthority(T(de.gaz.eedu.user.privileges.SystemPrivileges).CLASS_GET.toString())")
    @Override public @NotNull ResponseEntity<@NonNull ClassRoomModel> getData(@NotNull @PathVariable String id)
    {
    ...
    @Override public @NotNull ResponseEntity<ClassRoomModel @NonNull []> fetchAll()
    {
    ...
    public @NotNull ResponseEntity<ClassRoomModel @NonNull []> getOwn(@AuthenticationPrincipal long user)
    {
