...
public class SubjectController extends EntityController<String, SubjectService, SubjectModel, SubjectCreateModel>
{
    ...
    public @NotNull ResponseEntity<SubjectModel @NonNull []> create(@NotNull @RequestBody SubjectCreateModel[] model) throws CreationException
    {
    ...
    public @NotNull ResponseEntity<@NonNull Void> delete(@NotNull @PathVariable String[] id)
    {
    ...
    public @NotNull ResponseEntity<@NonNull SubjectModel> getData(@NotNull @PathVariable String id)
    {
    ...
    @GetMapping("/get/all")
    @PreAuthorize("hasAuthority(T(de.gaz.eedu.user.privileges.SystemPrivileges).SUBJECT_GET.toString())") @Override
    public @NotNull ResponseEntity<SubjectModel @NonNull []> fetchAll()
    {
    ...
    ) public @NotNull ResponseEntity<CourseModel @NonNull []> getCourses(@NotNull @PathVariable String[] subjects)
    {
